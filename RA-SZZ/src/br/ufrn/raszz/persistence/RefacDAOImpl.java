...
public class RefacDAOImpl extends RefacDAO {
	...
	@Override
	public synchronized void saveRefacResults(RefElement ref, String revisionType) {
	...
	public synchronized void saveCallersRefDiffResults(RefCaller caller, String revisionType) {
		...
		executeSQLWithParams(sql, caller.getRevision(), caller.getProject(), caller.getSummary(), caller.getEntityafter(),
				...
				revisionType, caller.getType(), caller.getTool().toString());
	}
	...
	@Override
	public synchronized void insertRefacRevisionsProcessed(String project, String revision, RefacToolType tool){
		String sql = "insert into szz_refac_revisionprocessed (project, revision, tool) values (:param1,:param2, :param3)";
		executeSQLWithParams(sql, project, revision, tool.toString());
	}
/*
