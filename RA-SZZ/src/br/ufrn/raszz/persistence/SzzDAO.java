...
public abstract class SzzDAO extends AbstractDAO {
	...
	public abstract Map<String,String> getAllRefacRevisionsProcessed(String project, RefacToolType tool);
	...
	public abstract List<RefElement> getRefacBic(String project, RefacToolType tool);
	
	public abstract RefElement getRefacBicBySummary(String project, String summary);
	
	public abstract long[] getIntervalEquivBeforeCaller(String revision, String summary, String path);
