...
public abstract class UtilQueryDAO extends AbstractDAO {
	...
	public abstract void insertDefects4jPatches(String project, String bug, String path, long linenumber,
			String content, boolean isRemovedLine);
	
	public abstract List<Object[]> getRemovedLineInDefects4jPatches(String project);
	
	public abstract List<Object[]> getStartLinesForProject(String project, boolean validstatus, String szztable);
	
	public abstract void updateHasInOtherImplementation(String project, String fixrevision, String startpath, long startlinenumber, boolean match, String szztable, String szz);
}
