...
import org.incava.diffj.function.Throws;
...
public class SvnRepositoryAdapter extends SzzRepositoryImpl implements SzzRepository {
	...
	public SzzRepository reset() throws Exception {
		encapsulation.closeSession();
		SVNRepository svnRepository = svnService.openRepository(url, user, password);
		return new SvnRepositoryAdapter(svnRepository, user, password, url, repositoryFolder);
	}
