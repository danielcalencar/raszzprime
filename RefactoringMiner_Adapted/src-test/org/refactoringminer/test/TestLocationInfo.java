...
public class TestLocationInfo {
	...
	public void testLocationInfoNormalLineEndings() {
		...
		LocationInfo locationInfo = new LocationInfo(string, "", 0, 3, 0);
		...
		locationInfo = new LocationInfo(string, "", -1, 3, 0);
		assertEquals(0, locationInfo.getStartLine());
		assertEquals(0, locationInfo.getEndLine());
		assertEquals(0, locationInfo.getStartColumn());
		...
		locationInfo = new LocationInfo(string, "", 3, 1, 0);
		assertEquals(0, locationInfo.getStartLine());
		assertEquals(0, locationInfo.getEndLine());
		assertEquals(0, locationInfo.getStartColumn());
		assertEquals(0, locationInfo.getEndColumn());
		
		locationInfo = new LocationInfo(string, "", 3, 1000, 0);
		assertEquals(0, locationInfo.getStartLine());
		assertEquals(0, locationInfo.getEndLine());
		assertEquals(0, locationInfo.getStartColumn());
		assertEquals(0, locationInfo.getEndColumn());
	
		locationInfo = new LocationInfo(string, "", 1, 25, 0);
		assertEquals(0, locationInfo.getStartLine());
		...
		locationInfo = new LocationInfo(string, "", 0, 35, 0);
		assertEquals(0, locationInfo.getStartLine());
	...
	public void testLocationInfoNoLineEndingAtTheEndOfTheFile() {
		...
		LocationInfo locationInfo = new LocationInfo(string, "", 23, 34, 0);
	...
	public void testLocationInfoWindowsLineEndings() {
		...
		locationInfo = new LocationInfo(string, "", 38, 40, 0);
