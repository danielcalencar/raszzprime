...
public class LocationInfo {
	...
	private int startFirstStatement;
	
	public LocationInfo(String fileContents, String filePath, int startOffset, int endOffset, int startFirstStatement) {
		this.filePath = filePath;
		this.startOffset = startOffset;
		this.endOffset = endOffset;
		this.startFirstStatement = startFirstStatement;
	...
	public int getStartFirstStatement() {
		return startFirstStatement;
	}
