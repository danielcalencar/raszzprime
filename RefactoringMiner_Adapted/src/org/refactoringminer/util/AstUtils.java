...
//	    String rawTypeName = stripQualifiedTypeName(stripTypeParamsFromTypeName(type.toString()));
	...
	public static int startPositionFirstStatement(VariableDeclarationFragment decl) {
		return new StatementCounter().startPositionFirstStatement(decl);
	}
	public static int startPositionFirstStatement(AnonymousClassDeclaration decl) {
		return new StatementCounter().startPositionFirstStatement(decl);
	}
	...
	private static class StatementCounter extends ASTVisitor {
		...
		public int startPositionFirstStatement(AnonymousClassDeclaration declaration) {
			counter = 0;
			startPositionFirstStatement = 0;
			declaration.accept(this);
			return startPositionFirstStatement;
		}
		public int startPositionFirstStatement(VariableDeclarationFragment declaration) {
			counter = 0;
			startPositionFirstStatement = 0;
			declaration.accept(this);
			return startPositionFirstStatement;
		...
		@Override
		public void preVisit(ASTNode node) {
			if (node instanceof Statement && !(node instanceof Block) /*&& !(node instanceof Annotation)*/) {	
				counter++;
